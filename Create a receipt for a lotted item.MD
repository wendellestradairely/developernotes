...
We can provide an arbitrary `lotNo` to the lot object in the `lots` array. It doesn't necessarily need to be existing. The system will auto-create the lot number if it doesn't exists.
